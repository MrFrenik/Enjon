...
// 		// World
// 		EntityManagerDeprecated WorldObject;

// 		eid32 FindNextAvailableEntity(EntityManagerDeprecated* Manager);
...
// 		struct EntityManagerDeprecated* NewEntityManagerDeprecated(int Width, int Height, EG::Camera2D* Camera, Level* Lvl)
// 		{
// 			// Set up world object
